...
class Atri:
	def __init__(self, state: Any):
		...
		self.first_page_container = state["first_page_container"]
	...
	@property
	def first_page_container(self):
		self._getter_access_tracker["first_page_container"] = {}
		return self._first_page_container
	@first_page_container.setter
	def first_page_container(self, new_state):
		self._setter_access_tracker["first_page_container"] = {}
		global default_state
		self._first_page_container = Flex(new_state, default_state["first_page_container"])
	...
	def _to_json_fields(self):
		return {
			...
			"Flex19": self._Flex19,
			"Flex16": self._Flex16,
			"first_page_container": self._first_page_container,
			"Flex21": self._Flex21,
			"Flex24": self._Flex24,
			"Flex26": self._Flex26,
			"Flex25": self._Flex25,
